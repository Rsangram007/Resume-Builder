...
import { Zap, Clock, Trash2, Edit, Award, TrendingUp, Check } from 'lucide-react';
  ...
  return (
    ...
    >
      {thumbnailImg ? (
        ...
        <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-500 via-violet-600 to-fuchsia-500">
