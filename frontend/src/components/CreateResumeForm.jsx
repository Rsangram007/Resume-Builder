  ...
  return (
    <div className='w-full max-w-md p-8 bg-white rounded-2xl border border-gray-100 shadow-lg'>
      ...
      <form onSubmit={handleCreateResume}>
        <Input
          value={title}
          onChange={({ target }) => setTitle(target.value)} // ✅ fixed here
          label='Resume Title'
          placeholder='e.g., Renu Rawat - Data Analyst'
          type='text'
        />
        ...
        <button
          type='submit'
          className='w-full py-3 bg-gradient-to-r from-rose-400 to-pink-600 text-white font-black rounded-2xl 
